...
public class Swagger2Config {
    ...
    public Docket webApiConfig(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //可以测试请求头中：输入token
//                .apis(RequestHandlerSelectors.withClassAnnotation(ApiOperation.class))  扫描全表
                .apis(RequestHandlerSelectors.basePackage("com.DLY.controller"))   //扫描那个包下的
                //过滤掉admin路径下的所有页面
    ...
    private ApiInfo webApiInfo(){
        ...
        return new ApiInfoBuilder()
                ...
                .version("1.0")
                .contact(new Contact("戴林宇", "没有个人网站", "1181434433@qq.com"))
                .build();
    }
